<template>
    <div class="padding grid grid-cols-1 gap-5 mt-8">
        ...
        <div class="max-w-7xl w-full p-10 bg-primario bg-opacity-20 rounded-xl">
            <p class="text-2xl text-texto font-light text-center">Tus polizas de vida a <span class="text-primario font-semibold">un solo click</span> </p>
        </div>
...
export default {
    ...
    async created() {
        if (this.policyRedirect) {
            router.push(`vida/${this.policyRedirect.id}`)
