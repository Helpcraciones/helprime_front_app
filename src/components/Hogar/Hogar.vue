<template>
	<div class="padding grid grid-cols-1 gap-5 mt-8">
      ...
      <div v-for="(risk, index) in this.homes" :key="index"  class="relative bg-white  border border-gray-100 shadow-md w-full h-30 h-30 flex justify-center items-center p-5 rounded-2xl transform transition-all hover:scale-105 duration-300 ease-in-out">
