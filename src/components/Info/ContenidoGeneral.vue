		...
		<div class="grid lg:grid-cols-3 grid-cols-1 w-full gap-10 lg:mt-10 mt-5">
			<div class="rounded-lg bg-white shadow-xl">
				...
				<div class="p-5 text-center">
					...
					<p class="text-sm leading-tight text-texto">Tenemos una plataforma muy completa, donde vas a poder afiliarte a una aseguradora y ver cuando desees todos tus seguros adquiridos.</p>
				</div>
			</div>
			<div class="rounded-lg bg-white shadow-xl">
					...
					<div class="p-5 text-center">
							...
							<p class="text-sm leading-tight text-texto">Si eres una empresa relacionada al gremio y te gustan los medios digitales, HELPRIME es tu mejor aliado para ofrecer tus servicios a la comunidad.</p>
					</div>
			</div>
			<div class="rounded-lg bg-white shadow-xl ">
					...
					<div class="p-5 text-center">
							...
							<p class="text-sm leading-tight text-texto">HELPRIME ofrece sus plataformas a las Agencias que deseen vincularse, digitalizar su negocio y tener un control total de sus clientes sin tener que gastar una millonada en desarrollo.</p>
					</div>
			</div>
		</div>
	</div>
