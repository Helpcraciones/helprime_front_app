<template>
    <div class="padding flex justify-center flex-col items-center lg:mt-20">
        <p class="text-texto text-4xl font-light">Únete a esta familia <span class="font-bold text-primario">HELPRIME</span></p>
