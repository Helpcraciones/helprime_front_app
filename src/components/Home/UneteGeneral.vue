<template>
    <div class="padding flex justify-center flex-col items-center lg:mt-20 mt-10">
        ...
        <div class="grid lg:grid-cols-3 grid-cols-1 w-full gap-10 lg:mt-10 mt-5">
            ...
            <div class="rounded-lg bg-white shadow-xl">
                ...
                <div class="p-5 text-center">
                    <p class="text-primario font-semibold text-xl leading-tight mb-5">Registrate como agencia de polizas</p>
                    <p class="two text-sm leading-tight text-texto">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores pariatur commodi esse officia ipsa.</p>
                    <button class="w-full bg-primario rounded-lg py-3 mt-5 bg-opacity-10 text-primario font-medium hover:bg-opacity-100 hover:text-white transition-all duration-300 ease-in-out border ">
                        Quiero mas informacion
                    </button>
                ...
                <div class="p-5 text-center">
                    <p class="text-primario font-semibold text-xl leading-tight mb-5">Maneja todo lo de tu vehiculo a un click</p>
                    <p class="two text-sm leading-tight text-texto">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores pariatur commodi esse officia ipsa.</p>
                    <button class="w-full bg-primario rounded-lg py-3 mt-5 bg-opacity-10 text-primario font-medium hover:bg-opacity-100 hover:text-white transition-all duration-300 ease-in-out border ">
                        Quiero mas informacion
                    </button>
